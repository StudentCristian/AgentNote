...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.TranscriptionOutput> {
          try {
          ...
          const __stream__ = this.stream.TranscribeAudio(
          audio_text,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            return __raw__.parsed(false) as types.TranscriptionOutput
            } catch (error) {
            ...
            audio_text: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.TranscriptionOutput, types.TranscriptionOutput>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for TranscribeAudio", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.TranscriptionOutput, types.TranscriptionOutput>(
                  __raw__,
                  (a): partial_types.TranscriptionOutput => a,
                  (a): types.TranscriptionOutput => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
